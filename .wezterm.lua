...
config.keys = {
  ...
  {key = 'q', mods = 'SHIFT|ALT', action = act.SplitVertical, },
  {key = 'a', mods = 'SHIFT|ALT', action = act.SplitHorizontal, },
  ...
  { key = 'a', mods = 'SHIFT|CTRL', action = act.AdjustPaneSize {'Left', 4}, },
  { key = 'd', mods = 'SHIFT|CTRL', action = act.AdjustPaneSize {'Right', 4}, },
  { key = 's', mods = 'SHIFT|CTRL', action = act.AdjustPaneSize {'Down', 4}, },
  { key = 'w', mods = 'SHIFT|CTRL', action = act.AdjustPaneSize {'Up', 4}, },
